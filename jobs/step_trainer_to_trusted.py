...
SELECT DISTINCT *
FROM myDataSource
WHERE sensorReadingTime IS NOT NULL AND serialNumber IS NOT NULL
'''
SQLQuery_node1744211243141 = sparkSqlQuery(glueContext, query = SqlQuery6776, mapping = {"myDataSource":AmazonS3_node1744211190246}, transformation_ctx = "SQLQuery_node1744211243141")
